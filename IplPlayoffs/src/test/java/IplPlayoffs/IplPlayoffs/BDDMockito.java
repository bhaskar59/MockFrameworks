...
public class BDDMockito {
	...
	public void testWithInjectMock(){
		...
		given(playOffLogic.eliminator1(Mockito.anyString(), Mockito.anyString())).willReturn("Banglore");
		given(playOffLogic.eliminator2(Mockito.anyString(), Mockito.anyString())).willReturn("Hyderabad");
